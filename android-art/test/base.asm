...
0000000000001000 <oatdata>:
    ...
    1008:	bc 55 d2 42 05       	mov    $0x542d255,%esp
    ...
    103d:	40 37                	rex (bad) 
    103f:	00 d9                	add    %bl,%cl
    1041:	0d 23 ab 00 00       	or     $0xab23,%eax
    1046:	dd 70 50             	fnsave 0x50(%rax)
    1049:	06                   	(bad)  
    ...
    112f:	2d 79 53 55 79       	sub    $0x79555379,%eax
    1134:	66 75 41             	data16 jne 1178 <oatdata+0x178>
    1137:	35 6d 6e 36 4f       	xor    $0x4f366e6d,%eax
    113c:	73 45                	jae    1183 <oatdata+0x183>
    113e:	4e                   	rex.WRX
    113f:	44 6b 57 49 35       	imul   $0x35,0x49(%rdi),%r10d
    1144:	76 41                	jbe    1187 <oatdata+0x187>
    ...
    1249:	2d 79 53 55 79       	sub    $0x79555379,%eax
    124e:	66 75 41             	data16 jne 1292 <oatdata+0x292>
    1251:	35 6d 6e 36 4f       	xor    $0x4f366e6d,%eax
    1256:	73 45                	jae    129d <oatdata+0x29d>
    1258:	4e                   	rex.WRX
    1259:	44 6b 57 49 35       	imul   $0x35,0x49(%rdi),%r10d
    125e:	76 41                	jbe    12a1 <oatdata+0x2a1>
